...
static const struct {
    ...
    {HARDWARE_adc_b_sw, "adc_b_sw", INT},
    {HARDWARE_adc_c_sw, "adc_c_sw", INT},
    {HARDWARE_adc_a_ch, "adc_a_ch", INT},
    {HARDWARE_adc_e_ch, "adc_e_ch", INT},
    {HARDWARE_adc_t_ch, "adc_t_ch", INT},
    {HARDWARE_adc_r_ch, "adc_r_ch", INT},
