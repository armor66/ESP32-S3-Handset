...
//my@
    STATE_CALIBRATION,
    STATE_CALIBR_ENDPOINTS,
    STATE_CALIBR_CENTRVALS,
    STATE_REVERSE_GIMBALS,
...
//my@
extern fsm_state_entry_t const linkstats_menu_fsm[];
extern fsm_state_entry_t const telemetry_menu_fsm[];
extern fsm_state_entry_t const gimbals_menu_fsm[];
//@
