...
extern uint8_t airBat_Val;
extern char flightMode[];
extern int32_t latitude;    //in degrees * 1e7, big-endian
extern int32_t longitude;
extern int16_t speed;       //ground speed in km/h * 10, big-endian
extern uint8_t sats;        //satellite count
extern bool calibrated;
extern uint8_t *p_tlmBuff;

extern uint32_t rollMin_tmp;
extern uint32_t rollCtr_tmp;
extern uint32_t rollMax_tmp;
extern uint32_t pitchMin_tmp;
extern uint32_t pitchCtr_tmp;
extern uint32_t pitchMax_tmp;
extern uint32_t thrtlMin_tmp;
extern uint32_t thrtlMax_tmp;
extern uint32_t yawMin_tmp;
extern uint32_t yawCtr_tmp;
extern uint32_t yawMax_tmp;
//@
