...
//my@
//Slider/Encoder
#define GPIO_ENC_CL  hardware_pin(HARDWARE_encoder_cl)
#define GPIO_ENC_DT  hardware_pin(HARDWARE_encoder_dt)
#define GPIO_ENC_SW  hardware_pin(HARDWARE_encoder_sw)
// VBat
