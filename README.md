4.0.0-S3-xLite firmware is ESP32-S3 based [ExpressLRS](https://github.com/ExpressLRS/ExpressLRS) Handset . 
...
Due to CoreWing 2400.json, GPIO18 is ADC battery pin, GPIO15, 16(instead of right 3-position switch) and 6(button) - rotary encoder,
 ...
 flashed with [BLE Telemetry Lite](https://github.com/BushlanovDev/ble-telemetry-lite),
 that gives support [TelemetryViewer](https://github.com/RomanLut/android-taranis-smartport-telemetry). 
