...
Build "Unified_ESP32_S3_2400_TX_Via_UATR", choose "CoreWing Sirius 2.4GHz TX" configuration.
Die to CoreWing 2400.json, GPIO18 - ADC battery pin, GPIO15, 16(instead of right 3-position switch) and 6 - encoder,
 ...
 flashed [BLE Telemetry Lite](https://github.com/BushlanovDev/ble-telemetry-lite/releases),
 supported [TelemetryViewer](https://github.com/RomanLut/android-taranis-smartport-telemetry/releases).
