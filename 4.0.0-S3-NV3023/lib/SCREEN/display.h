...
#define CHANGED_CALIBRATION bit(6)
#define CHANGED_MODELMATCH bit(7)
...
typedef enum
{
    SCREEN_BACKLIGHT_OFF = 0,
    SCREEN_BACKLIGHT_ON = 1
} screen_backlight_t;
...
public:
    ...
    virtual void displayTelemetry() = 0;    //my@
    virtual void displayGimbals() = 0;      //my@
