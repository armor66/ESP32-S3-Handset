...
// GIMBALS
#define GPIO_ANALOG_AIL hardware_pin(HARDWARE_adc_a_ch)
#define GPIO_ANALOG_ELE hardware_pin(HARDWARE_adc_e_ch)
#define GPIO_ANALOG_THR hardware_pin(HARDWARE_adc_t_ch)
#define GPIO_ANALOG_RUD hardware_pin(HARDWARE_adc_r_ch)

// Switches/Sliders
// #define GPIO_ANALOG_BSW hardware_pin(HARDWARE_adc_b_sw)
// #define GPIO_ANALOG_CSW hardware_pin(HARDWARE_adc_c_sw)
#define GPIO_ANALOG_SLIDER hardware_pin(HARDWARE_adc_slider)